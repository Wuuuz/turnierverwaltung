...
class AnmeldungUebersichtController extends Controller
{
    /**
     * @Route("/turnierplan/erstellung", name="spAnmeldungList")
     */
    public function listAction()
    {
        ...
        return $this->render('@Turnierplan/AnmeldungUebersicht/list.html.twig', array(
